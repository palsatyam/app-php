...
<head>
  ...
  <style>
    ...
    table{  
       margin-top: 100px;
       margin-left: 370px;
       background-color: rgb(26, 155, 187);
    }
    table,
    th,
    td {
      ...
      th{
        background-color: rgb(24, 110, 121);
      }
      td{
        text-align: center;
      }
      ...
      tr:nth-child(even){
        background-color: rgb(217, 205, 219);
      }
      tr:hover{
...
<body>
  ...
  <table>
    ...
    <tr>
      <td> 10-11-2022 </td>
      <td>String Length</td>
      <td><a href="lrn-progress/string-length.php"> Check-Out-This</a> </td>
    </tr>
